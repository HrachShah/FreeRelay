...
def _build_engine(settings: Settings) -> RoutingEngine:
    """Build the routing engine and register all configured providers."""
    ...
    provider_configs: list[tuple[type, str, int | None]] = [
        (GroqProvider, keys.groq_api_key, 500_000),
        (GoogleProvider, keys.google_ai_key, None),  # unlimited daily
