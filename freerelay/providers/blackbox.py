"""
FreeRelay — Blackbox AI Provider
==================================
OpenAI-compatible API. Free models available (e.g. blackboxai/minimax/minimax-free).
"""
...
class BlackboxProvider(BaseProvider):
    """Blackbox AI provider — OpenAI-compatible, free tier available."""

    name = "blackbox"
    base_url = "https://api.blackbox.ai/v1"
    supported_features = {"streaming"}

    _default_model = "blackboxai/anthropic/claude-opus-4.7"
